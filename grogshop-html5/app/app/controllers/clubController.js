(function(){
    var clubController = function ($scope, $routeParams, $rootScope, $location, $upload, $timeout, $clubs, $memberships, $items, $comments, appConstants) {
    ...
    clubController.$inject = ['$scope','$routeParams','$rootScope','$location','$upload','$timeout', '$clubs','$memberships','$items','$comments', 'appConstants'];
